...
const ContactSection = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      ...
      <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
        <div className="lg:w-1/2 px-6">
          <h2 className="title-font font-semibold text-TextColor tracking-widest text-xs">📍 Factory Address</h2>
          <p className="mt-1">Sweet Street, Chocolate Town, Cocoa Valley, 56789</p>
        </div>
        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
          <h2 className="title-font font-semibold text-TextColor tracking-widest text-xs">EMAIL</h2>
          <a className="text-indigo-500 leading-relaxed">hello@cocoafactory.com</a>
    ...
    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      ...
      <p className="leading-relaxed mb-5 text-gray-600">Name | Email | Message | [Send Message]</p>
